...
function Home() {
    ...
    const handleViewdetailsButton = service => {
    ...
    if (services.length > 0) {
        ...
        return (
            <div className='flex justify-center my-5'>
                <div role="status">
                    <svg aria-hidden="true" className="inline w-8 h-8 text-gray-200 animate-spin dark:text-gray-600 fill-green-700" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
